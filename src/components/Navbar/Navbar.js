...
export default function Navbar(props) {
  ...
  return (
    <div className="relativeNavbar">
      <div
        className={
          classSidebarRight === false
            ? `${styles.containerDropdownNavbarRight}`
            : `${styles.dropdownOpenRight}`
        }
      >
        <div className={styles.topDropdown}>
          <div
            className={styles.crossDropdown}
            onClick={() => {
              setclassSidebarRight((classSidebarRight = !classSidebarRight));
            }}
          >
            <RxCross1 />
          </div>
      ...
      <div
        className={
          classSidebar === false
            ? `${styles.containerDropdownNavbar}`
            : `${styles.dropdownOpen}`
        }
      >
        <div className={styles.topDropdown}>
          ...
          <div
            className={styles.crossDropdown}
            onClick={() => {
              setclassSidebar((classSidebar = !classSidebar));
            }}
          >
            <RxCross1 />
          </div>
      ...
      <nav>
        ...
        {router.pathname === "/" ? (
          <div className={`${styles.navitem} ${styles.input}`}>
        ...
        <div className={`${styles.navitem} ${styles.rightNav}`}>
          ...
          >
            ...
            <div className={styles.favoritesNav}>{panier.length}</div>
          </div>
        </div>
      </nav>
    </div>
